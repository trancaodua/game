<script setup>
import HaderCarousel from './carousel/HeaderCarousel.vue';
import BroadCast from './BroadCast.vue';
import GameMenu from './GameMenu.vue';
import MiddleCarousel from './carousel/MiddleCarousel.vue';
import MiniCarousel from './carousel/MiniCarousel.vue';
...
export default {
    data() {
        return {
            ...
            gameTypeFour: { name: "GAME BÀI", image: "https://www.123bcc.com/home/static-game/img/qp_css_sprites.0d56dc9b.png", backgroundPosition: "-10.2em -0.07em" },
        };
    }
}
</script>
